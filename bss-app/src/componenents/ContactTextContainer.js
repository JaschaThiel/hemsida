  ...
  return (
    ...
    <div className={classes.root}>
      <Typography variant="inherit" paragraph={true} align="left" >
        Här hittar du kontaktuppgifter till mig. Längre ner berättar jag lite om mig och ännu längre ner hittar du ett bildgalleri. 
      </Typography>
      <Typography variant="inherit" paragraph={true} align="left" >
        Jag är tillgänglig på telefon vardagar kl. 9:00 - 16:00, men det kan vara så att jag håller på med någonting som gör att jag inte kan svara
        eller inte hör telefonen. Du får gärna lämna ett meddelande på telefonsvararen eller, ännu bättre, skicka ett sms, mejl eller använda
        nedan nämnda sociala medier. Jag hör sedan av mig så fort jag kan.
      </Typography>
      <Typography variant="inherit" paragraph={true} align="left" >
        <b>Gunnar Thiel</b>
        <br></br>
        ...
        <u>Kontorstider:</u><br></br>
        Vardagar kl. 09:00 - 16:00<br></br>
        Torsdagar kl 09:00 - 19:00<br></br><br></br>
