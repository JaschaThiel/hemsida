  ...
  return (
    <div className={classes.root} >
      <Typography variant="inherit" paragraph={true} align="left" >
        Jag erbjuder snöskottning på tomten, inte på vägar utanför eller till tomten.
        Är det lite snö kan det vara rimligt att skotta mer regelbundet för att skapa intrycket om att huset är bebott,
